...
describe('MunicipalitiesRepository', () => {
  ...
  describe('singleton pattern', () => {
    it('returns the same instance on every import', async () => {
      const { default: firstImport } = await import('../../repository/Municipalities/Municipalities.repository');
      const { default: secondImport } = await import('../../repository/Municipalities/Municipalities.repository');
  ...
  describe('data initialization', () => {
    it('initializes data as an empty array', async () => {
      const repo = await import('../../repository/Municipalities/Municipalities.repository');
